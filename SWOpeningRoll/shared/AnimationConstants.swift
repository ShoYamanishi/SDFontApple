...
class AnimationConstants {
    ...
    static let Dimension1     = CGSize( width: 0.3, height: 0.06 )
    static let Scale1         = 1000.0
    static let Translation1   = SIMD3<Float>( x: 0.065, y: -0.02, z: -0.15 )
    ...
    static let Dimension2     = CGSize( width: 1.0, height: 0.6 )
    static let Scale2         = 50.0
...
"""
    ...
    static let Dimension3     = CGSize( width: 0.3, height: 0.5 )
    static let Scale3         = 1000.0
    static let Translation3_1 = SIMD3<Float>( x: 0.0, y: -0.03, z:   0.3 )
    static let Translation3_2 = SIMD3<Float>( x: 0.0, y: -0.03, z:  -0.5 + 0.3 )
    static let Translation3_3 = SIMD3<Float>( x: 0.0, y: -0.03, z:  -0.5 - 0.25 + 0.3 )
    static let Translation3Demo = SIMD3<Float>( x: 0.0, y: -0.03, z:  0.1 )

    static let TemporalPoints3  : [TimeInterval] = [ 0.0,            7.99,           8.0,            28.0,           38.0,          ]
